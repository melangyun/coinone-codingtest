...
import { UserAgreeHistoryRepository } from './userAgreeHistory.memoryRepository';

const userAgreeHistoryDtos = JSON.parse(
...
@Injectable()
export class UserAgreeHistoryMemoryRepository
  implements UserAgreeHistoryRepository {
