...
import { AgreeHistoryRepository } from './agreeHistory.memoryRepository';

const AGREE_HISTORY_DTOS = JSON.parse(
...
@Injectable()
export class AgreeHistoryMemoryRepository implements AgreeHistoryRepository {}
